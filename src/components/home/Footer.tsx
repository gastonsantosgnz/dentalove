  ...
  const socials = [
    {
      name: "twitter",
      icon: (
        <svg className="h-5 w-5 hover:text-blue-500 transition duration-150" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      name: "LinkedIn",
      icon: (
        <svg className="h-5 w-5 hover:text-blue-700 transition duration-150" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      name: "Facebook",
      icon: (
        <svg className="h-5 w-5 hover:text-blue-600 transition duration-150" fill="currentColor" viewBox="0 0 24 24">
