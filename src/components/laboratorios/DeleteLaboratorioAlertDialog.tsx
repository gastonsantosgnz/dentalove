...
interface DeleteLaboratorioAlertDialogProps {
  isOpen: boolean;
...
export function DeleteLaboratorioAlertDialog({
  isOpen,
  onOpenChange,
  laboratorioName,
  onDelete,
  trigger,
}: DeleteLaboratorioAlertDialogProps) {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <strong>{laboratorioName}</strong> del sistema.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
