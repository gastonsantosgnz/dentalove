    ...
    <DayPicker
      ...
      components={{
        MonthCaption: ({ calendarMonth, ...props }) => {
          return (
            <div className="flex justify-center items-center mb-4 h-8 relative">
              <div className="text-sm font-medium">
                {calendarMonth.date.toLocaleDateString('es-ES', { 
                  month: 'long', 
                  year: 'numeric' 
        ...
        Nav: ({ previousMonth, nextMonth, onPreviousClick, onNextClick, ...props }) => {
          return (
