-- TABLA DE EMPLEADOS PARA SISTEMA DE GASTOS
...
-- 6. ACTUALIZAR VISTA MEJORADA PARA INCLUIR EMPLEADOS
...
-- 9. INSERTAR EMPLEADOS DE EJEMPLO (OPCIONAL - comentado)
/*
...
-- 10. COMENTARIOS EN TABLAS PARA DOCUMENTACIÓN
